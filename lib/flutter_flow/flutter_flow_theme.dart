...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF233D75);
  late Color secondary = const Color(0xFFC19C57);
  late Color tertiary = const Color(0xFFA69FBE);
  late Color alternate = const Color(0xFFC05D73);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFAF7F1);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFC2CFED);
  late Color accent2 = const Color(0xFFF1E9DA);
  late Color accent3 = const Color(0xFFEBEAF1);
  late Color accent4 = const Color(0xFFF1DBE0);
