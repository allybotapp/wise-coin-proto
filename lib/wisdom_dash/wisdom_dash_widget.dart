...
import 'wisdom_dash_model.dart';
export 'wisdom_dash_model.dart';

class WisdomDashWidget extends StatefulWidget {
  const WisdomDashWidget({super.key});

  @override
  State<WisdomDashWidget> createState() => _WisdomDashWidgetState();
}

class _WisdomDashWidgetState extends State<WisdomDashWidget>
    with TickerProviderStateMixin {
  late WisdomDashModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WisdomDashModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'WisdomDash'});
